    ...
    <section>
      ...
      <div class="obrazky">
        ...
        <img class="obrayky_img" src="Loga png/Casovy-menezment-3lvl.png" alt="">
        <img class="obrayky_img" src="Loga png/Citatelske-zrucnosti-1lvl.png" alt="">
        <img class="obrayky_img" src="Loga png/Diskusia-2lvl.png" alt="">
        <img class="obrayky_img" src="Loga png/Praca-v-time-0lvl.png" alt="">
        <img class="obrayky_img" src="Loga png/Kryticke-myslenie-3lvl.png" alt="">
      ...
      <div class="timeline">
        ...
        <!-- <div class="obrazky">
          ...
          <img class="obrayky_img" src="Loga png/Casovy-menezment.png" alt="">
          <img class="obrayky_img" src="Loga png/Citatelske-zrucnosti.png" alt="">
          <img class="obrayky_img" src="Loga png/Diskusia.png" alt="">
          <img class="obrayky_img" src="Loga png/Praca-v-time.png" alt="">
          <img class="obrayky_img" src="Loga png/Kriticke-myslenie.png" alt="">
      ...
      <!-- <div class="events-content">
        <ol>
          ...
          <li data-date="26/00/00">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
          </li>
          <li data-date="27/00/00">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
          </li>
          <li data-date="28/00/00">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
          </li>
        </ol>
      </div> -->
